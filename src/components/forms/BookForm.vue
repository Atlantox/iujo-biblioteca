...
<template>
    <form class="row m-0 p-0 justify-content-around align-items-start" @submit.prevent="ValidateForm">
        ...
        />
        <div class="col-12 col-lg-8 row m-0 my-4 p-2 pt-5 fs-4 myForm shadowed-l rounded lb-bg-terciary-ul">
        ...
        <div class="col-12 col-lg-3 row m-0 my-4 p-4 fs-4 myForm shadowed-l rounded lb-bg-terciary-ul justify-content-center">
            <h2 class="col-12 text-center">Categorías</h2>
            <div class="col-12 col-lg-10 d-flex justify-content-center align-items-center flex-column rounded shadowed-l p-0 bg-white" style="overflow:hidden">
